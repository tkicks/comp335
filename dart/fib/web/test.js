...
["", "fib.dart", , T, {
  "^": "",
  main: [function() {
    var t1 = J.get$onInput$x(document.querySelector("#input"));
    H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(T.updateN$closure()), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
  }, "call$0", "main$closure", 0, 0, 1],
  updateN: [function(e) {
    var n, t1;
    n = H.interceptedTypeCast(J.get$target$x(e), "$isInputElement").valueAsNumber;
    n.toString;
    t1 = document.querySelector("#output");
    $.outputText = t1;
    t1.textContent = J.toString$0(n);
  }, "call$1", "updateN$closure", 2, 0, 6]
},
1],
]);
